 ...
 */
char HostAddress[255] = AWS_IOT_ENDPOINT;
...
void aws_iot_task(void (*iot_callback_handler)(AWS_IoT_Client *, char *, uint16_t ,
   ...
   // mqttInitParams.pRootCALocation = (const char *)AWS_CERT_CA;
   // mqttInitParams.pDeviceCertLocation = (const char *)AWS_CERT_CRT;
   // mqttInitParams.pDevicePrivateKeyLocation = (const char *)AWS_CERT_PRIVATE;
    ...
    rc = aws_iot_mqtt_subscribe(&client, TOPIC, TOPIC_LEN, QOS0, iot_callback_handler, NULL);
    if(SUCCESS != rc) {
    ...
    while((NETWORK_ATTEMPTING_RECONNECT == rc || NETWORK_RECONNECTED == rc || SUCCESS == rc)) {
                ...
                if (loop%3600==0)
        {
            ...
            vTaskDelay(HEALTHCHECKDELAY / portTICK_RATE_MS);
            sprintf(cPayload, "{\"action\":\"hello\",\"thing\":\"%s\",\"version\":\"%s\"}",CLIENT_ID,VERSION);
